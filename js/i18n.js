...
const I18N_STRINGS = {
  ko: {
    ...
    'meta.desc': '자폐·신경다양성을 위한 저자극 AI 스카이, DEI 데이터 아웃소싱 뉴로크래프트. 사회적기업 초기창업지원사업 선정 AI41이 만듭니다.',
    'badge.prep': '사회적기업 초기창업지원사업 선정',
    'nav.home': '홈',
    'nav.mission': '미션',
    'nav.products': '제품',
    'nav.impact': '임팩트',
    ...
    'achieve.social': '사회적기업 초기창업지원사업 선정',
  ...
  en: {
    ...
    'meta.desc': 'Low-stimulus AI Sky for autism and neurodiversity, and NeuroCraft DEI data outsourcing — by AI41, selected for the Social Enterprise Early Startup Support Program.',
    'badge.prep': 'Selected: Social Enterprise Early Startup Support',
    'nav.home': 'Home',
    'nav.mission': 'Mission',
    ...
    'achieve.social': 'Social Enterprise Early Startup Support',
  ...
  ja: {
    ...
    'meta.desc': '自閉・ニューロダイバーシティ向け低刺激AIスカイと、DEIデータアウトソーシングのニューロクラフト。社会的企業初期創業支援事業に選定されたAI41。',
    'badge.prep': '社会的企業 初期創業支援事業 選定',
    'nav.home': 'ホーム',
    'nav.mission': 'ミッション',
    'nav.products': 'プロダクト',
    'nav.impact': 'インパクト',
    ...
    'achieve.social': '社会的企業 初期創業支援事業 選定',
  ...
  zh: {
    ...
    'meta.desc': '面向自闭与神经多样性的低刺激AI Sky，以及DEI数据外包 NeuroCraft。由获选社会企业初期创业支持项目的 AI41 打造。',
    'badge.prep': '社会企业初期创业支持项目 入选',
    'nav.home': '首页',
    'nav.mission': '使命',
    'nav.products': '产品',
    'nav.impact': '影响',
    ...
    'achieve.social': '社会企业初期创业支持项目 入选',
