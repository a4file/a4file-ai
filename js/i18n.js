...
const I18N_STRINGS = {
  ko: {
    ...
    'nav.group.company': '회사',
    'nav.group.products': '제품',
    'nav.group.impact': '임팩트',
    'nav.group.join': '함께하기',
    'nav.home': '홈',
    'nav.mission': '미션',
    'nav.products': '제품',
    'nav.solutions': '스카이·뉴로크래프트',
    'nav.guide': '실행 가이드',
    'nav.impact': '임팩트',
    'nav.achievements': '성과',
    'nav.partners': '파트너',
    ...
    'story.h2': '우리가 어떤 회사인지',
    'story.sub': 'AI41은 서울 송파구에서 뉴로크래프트와 스카이를 만듭니다.<br>개인사업자로 시작해 법인 전환과 예비사회적기업 지정을 진행 중입니다. 스카이는 치료가 아닙니다.',
    'story.cta': '이야기와 실행 가이드',
    'products.h2': '스카이 · 뉴로크래프트 · 좋은 집',
    'products.sub': '일상, 일자리, 머물 곳. 웹 솔루션은 월 구독으로 같이 엽니다.',
    'sky.h3': '저자극 AI Companion',
    'sky.p': '신경다양성 당사자·가족을 위한 일상 지원 AI',
    'sky.f1': '사회성', 'sky.f2': '루틴', 'sky.f3': '감정조절', 'sky.f4': '의사소통', 'sky.f5': '미니게임', 'sky.f6': '타로',
    'sky.cta': '체험하기',
    'house.h3': '좋은 집 찾기',
    'house.p': '경매 · 공매 · 서울 모아주택 부지를 한 지도에서. 자주 보게 하고, 가입하면 웹 솔루션을 엽니다.',
    'nc.h3': 'Managed AI Workforce',
    'nc.p': '신경다양성 인재를 AI 데이터 전문가와 생성형 AI 창작자로 키워 기업에 연결합니다.',
    ...
    'achieve.kakao.p': '자체 MCP 프로젝트 승인 · 전용 서버',
    'achieve.expo': '오티즘엑스포',
    'achieve.expo.p': '스카이 현장 실증 · TRL 6',
    'achieve.hub': 'AI 디지털배움터',
    'achieve.hub.p': '과기정통부 교육 프로그램 현장 검증',
    'achieve.gap': '경기청년갭이어',
    'achieve.gap.p': 'AI 영상 부문 멘토기업 · 6팀',
    'achieve.social': '사회적기업 창업지원사업 선정',
    'achieve.social.p': '초기창업형 · 예비사회적기업 진입 진행',
    'partners.h2': '연대 허브',
    'blog.h2': 'AI41 소식',
    ...
    'footer.corp': 'AI41 · AI FOR ONE · 서울 송파구 · 창업 2025.08.25',
    ...
    'route.quote': '견적 프로그램으로 나눠 볼게!',
    'route.maps': '지도를 찾아볼게!',
    'route.house': '좋은 집 지도로 갈게!',
    'route.aboutAi41': 'AI41을 소개할게!',
    'route.aboutSky': '스카이를 소개할게!',
    'route.search': '검색창을 열게!',
    'route.utils': '계산 도구를 열게!',
    'weather.fail': '날씨를 불러오지 못했어요.',
    'maps.fail': '장소를 찾지 못했어요.',
    'utils.title': '계산 도구',
    'utils.sub': '평수, 대출, 디데이, 환율, 대기질, 타이머. 숫자는 프로그램이 계산해요.',
    'utils.fxFail': '환율을 못 가져왔어요.',
    'utils.airFail': '대기질을 못 가져왔어요.',
    'search.title': '검색',
    'search.sub': '구글은 결과를 여기서 보여 주고, 네이버는 새 탭으로 열어요.',
    'search.query': '찾을 말',
    'search.placeholder': '예: 신경다양성 일자리',
    'search.google': '구글 검색',
    'search.naver': '네이버 검색',
    'search.needQuery': '찾을 말을 적어 주세요. 예: 「구글에서 신경다양성 검색」',
    'sky.apiKey': 'API 키',
    'fab.home': '홈으로',
  ...
  en: {
    ...
    'nav.group.impact': 'Impact',
    'nav.group.join': 'Work with us',
    'nav.home': 'Home',
    'nav.mission': 'Mission',
    'nav.products': 'Products',
    'nav.solutions': 'Sky · NeuroCraft',
    'nav.guide': 'How-to',
    'nav.impact': 'Impact',
    ...
    'story.h2': 'Who we are',
    'story.sub': 'AI41 builds NeuroCraft and Sky in Songpa, Seoul.<br>We started as a sole proprietor and are incorporating, pursuing preparatory social-enterprise status. Sky is not treatment.',
    'story.cta': 'Story and how-to guide',
    'products.h2': 'Sky · NeuroCraft · Homes',
    'products.sub': 'Daily life, jobs, and a place to stay. Web tools open with one monthly plan.',
    ...
    'sky.cta': 'Try it',
    'house.h3': 'Find a home',
    'house.p': 'Court auction, Onbid public sale, and Seoul Moa housing sites on one map.',
    'nc.h3': 'Managed AI Workforce',
    'nc.p': 'We train neurodivergent talent as AI data specialists and generative-AI creators, then connect them with companies.',
    ...
    'achieve.kakao.p': 'Approved MCP project · dedicated server',
    'achieve.expo': 'Autism Expo',
    'achieve.expo.p': 'On-site Sky pilot · TRL 6',
    'achieve.hub': 'AI Digital Learning Hub',
    'achieve.hub.p': 'MSIT education-program field test',
    'achieve.gap': 'Gyeonggi Youth Gap Year',
    'achieve.gap.p': 'AI video mentor · 6 teams',
    'achieve.social': 'Social Enterprise Startup Support',
    'achieve.social.p': 'Early-startup track · preparatory certification in progress',
    ...
    'footer.corp': 'AI41 · AI FOR ONE · Songpa, Seoul · Started 2025.08.25',
    ...
    'route.quote': 'I’ll run the quote program!',
    'route.maps': 'Looking that place up!',
    'route.aboutAi41': 'Here’s AI41!',
    'route.aboutSky': 'Here’s Sky!',
    'route.search': 'Opening search!',
    'route.house': 'Opening the home map!',
    'route.utils': 'Opening calculators!',
    'weather.fail': 'Could not fetch the weather.',
    'maps.fail': 'Could not find that place.',
    'utils.title': 'Tools',
    'utils.sub': 'Area, loan, D-day, FX, air quality, timer. Numbers come from the program.',
    'utils.fxFail': 'Could not fetch the exchange rate.',
    'utils.airFail': 'Could not fetch air quality.',
    'search.title': 'Search',
    'search.sub': 'Opens Google or Naver in a new tab.',
    'search.query': 'What to find',
    'search.placeholder': 'e.g. neurodiversity jobs',
    'search.google': 'Google',
    'search.naver': 'Naver',
    'search.needQuery': 'Type what to search. Example: “search Google for neurodiversity”.',
    'sky.apiKey': 'API key',
    'fab.home': 'Home',
  ...
  ja: {
    ...
    'nav.group.company': '会社',
    'nav.group.products': 'プロダクト',
    'nav.group.impact': 'インパクト',
    'nav.group.join': '一緒に',
    'nav.home': 'ホーム',
    'nav.mission': 'ミッション',
    'nav.products': 'プロダクト',
    'nav.solutions': 'スカイ・ニューロクラフト',
    'nav.guide': 'ガイド',
    'nav.impact': 'インパクト',
    'nav.achievements': '成果',
    'nav.partners': 'パートナー',
    ...
    'story.h2': '私たちがどんな会社か',
    'story.sub': 'AI41はソウル松坡区でニューロクラフトとスカイを作っています。<br>個人事業から法人化と予備社会的企業の指定を進めています。スカイは治療ではありません。',
    'story.cta': 'ストーリーと使い方',
    'products.h2': 'スカイ · ニューロクラフト · 住まい',
    'products.sub': '日常、仕事、住む場所。ウェブの道具は月額でまとめて開けます。',
    'sky.h3': '低刺激AIコンパニオン',
    'sky.p': '当事者・家族の日常を支えるAI',
    'sky.f1': '社会性', 'sky.f2': 'ルーチン', 'sky.f3': '感情調整', 'sky.f4': 'コミュニケーション', 'sky.f5': 'ミニゲーム', 'sky.f6': 'タロット',
    'sky.cta': '体験する',
    'house.h3': '住まいを探す',
    'house.p': '競売・公売・ソウルモア住宅の敷地を一枚の地図で。',
    'nc.h3': 'Managed AI Workforce',
    'nc.p': 'ニューロダイバーシティ人材をAIデータ専門家と生成AI創作者として育て、企業につなぎます。',
    ...
    'achieve.kakao.p': '独自MCPプロジェクト承認 · 専用サーバー',
    'achieve.expo': 'オティズムエキスポ',
    'achieve.expo.p': 'スカイ現場実証 · TRL 6',
    'achieve.hub': 'AIデジタル学び場',
    'achieve.hub.p': '科学技術情報通信部の教育プログラム現場検証',
    'achieve.gap': '京畿青年ギャップイヤー',
    'achieve.gap.p': 'AI映像メンター企業 · 6チーム',
    'achieve.social': '社会的企業 創業支援事業 選定',
    'achieve.social.p': '初期創業型 · 予備社会的企業の進入を進行中',
    'partners.h2': '連帯ハブ',
    'blog.h2': 'AI41ニュース',
    ...
    'footer.corp': 'AI41 · AI FOR ONE · ソウル松坡区 · 創業 2025.08.25',
    ...
    'route.quote': '見積プログラムで分けるね！',
    'route.maps': '地図を探すね！',
    'route.aboutAi41': 'AI41を紹介するね！',
    'route.aboutSky': 'スカイを紹介するね！',
    'route.search': '検索を開くね！',
    'route.house': '住まいの地図を開くね！',
    'route.utils': '計算ツールを開くね！',
    'weather.fail': '天気を取得できませんでした。',
    'maps.fail': '場所が見つかりませんでした。',
    'utils.title': '計算ツール',
    'utils.sub': '坪数、ローン、D-day、為替、大気質、タイマー。数字はプログラムが出します。',
    'utils.fxFail': '為替を取得できませんでした。',
    'utils.airFail': '大気質を取得できませんでした。',
    'search.title': '検索',
    'search.sub': 'Google または Naver を新しいタブで開きます。',
    'search.query': '探す言葉',
    'search.placeholder': '例: ニューロダイバーシティ',
    'search.google': 'Google 検索',
    'search.naver': 'Naver 検索',
    'search.needQuery': '探す言葉を書いてください。例: 「Googleで検索」',
    'sky.apiKey': 'APIキー',
    'fab.home': 'ホームへ',
  ...
  zh: {
    ...
    'nav.group.company': '公司',
    'nav.group.products': '产品',
    'nav.group.impact': '影响',
    'nav.group.join': '一起做',
    'nav.home': '首页',
    'nav.mission': '使命',
    ...
    'story.h2': '我们是怎样的公司',
    'story.sub': 'AI41在首尔松坡区做 NeuroCraft 与 Sky。<br>从个体经营起步，正在法人化并申请预备社会企业。Sky不是治疗。',
    'story.cta': '故事与使用指南',
    'products.h2': 'Sky · NeuroCraft · 找房',
    'products.sub': '日常、工作、落脚处。网页工具用月订阅一起打开。',
    'sky.h3': '低刺激 AI Companion',
    'sky.p': '面向当事人与家庭的日常支持AI',
    'sky.f1': '社交', 'sky.f2': '节奏', 'sky.f3': '情绪调节', 'sky.f4': '沟通', 'sky.f5': '小游戏', 'sky.f6': '塔罗',
    'sky.cta': '去体验',
    'house.h3': '找好房子',
    'house.p': '拍卖、公卖、首尔모아住宅用地，一张地图。',
    'nc.h3': 'Managed AI Workforce',
    'nc.p': '把神经多样性人才培养为 AI 数据专家与生成式 AI 创作者，并连接到企业。',
    ...
    'achieve.kakao.p': '自有 MCP 项目获批 · 专用服务器',
    'achieve.expo': '自闭症博览会',
    'achieve.expo.p': 'Sky 现场实证 · TRL 6',
    'achieve.hub': 'AI 数字学堂',
    'achieve.hub.p': '科技部教育项目现场验证',
    'achieve.gap': '京畿青年间隔年',
    'achieve.gap.p': 'AI 影像导师企业 · 6 支队伍',
    'achieve.social': '社会企业创业支持项目 入选',
    'achieve.social.p': '初期创业型 · 预备社会企业进入进行中',
    'partners.h2': '连带枢纽',
    'blog.h2': 'AI41 动态',
    ...
    'footer.corp': 'AI41 · AI FOR ONE · 首尔松坡区 · 创业 2025.08.25',
    ...
    'route.quote': '用报价程序来拆！',
    'route.maps': '我来找地图！',
    'route.aboutAi41': '来介绍 AI41！',
    'route.aboutSky': '来介绍 Sky！',
    'route.search': '打开搜索！',
    'route.house': '打开找房地图！',
    'route.utils': '打开计算工具！',
    'weather.fail': '天气获取失败。',
    'maps.fail': '找不到该地点。',
    'utils.title': '计算工具',
    'utils.sub': '坪数、贷款、倒数日、汇率、空气、计时器。数字由程序计算。',
    'utils.fxFail': '无法获取汇率。',
    'utils.airFail': '无法获取空气质量。',
    'search.title': '搜索',
    'search.sub': '在新标签页打开谷歌或 Naver。',
    'search.query': '要找的词',
    'search.placeholder': '例如：神经多样性',
    'search.google': '谷歌搜索',
    'search.naver': 'Naver 搜索',
    'search.needQuery': '请写下要搜索的内容。例如：「用谷歌搜索」',
    'sky.apiKey': 'API 密钥',
    'fab.home': '回首页',
  ...
  fr: {
    ...
    'nav.group.company': 'Entreprise',
    'nav.group.products': 'Produits',
    'nav.group.impact': 'Impact',
    'nav.group.join': 'Ensemble',
    'nav.home': 'Accueil',
    'nav.mission': 'Mission',
    ...
    'story.h2': 'Qui nous sommes',
    'story.sub': 'AI41 construit NeuroCraft et Sky à Songpa, Séoul.<br>Nous avons commencé en entreprise individuelle et avançons vers la société et le statut d’entreprise sociale préparatoire. Sky n’est pas un traitement.',
    'story.cta': 'Histoire et mode d’emploi',
    'products.h2': 'Sky · NeuroCraft · Logement',
    'products.sub': 'Le quotidien, le travail, un lieu. Les outils web s’ouvrent avec un abonnement.',
    ...
    'sky.cta': 'Essayer',
    'house.h3': 'Trouver un logement',
    'house.p': 'Enchères, ventes publiques et sites Moa à Séoul sur une carte.',
    'nc.h3': 'Managed AI Workforce',
    'nc.p': 'Nous formons des talents neurodivergents comme spécialistes data IA et créateurs d’IA générative, puis les relions aux entreprises.',
    ...
    'achieve.kakao.p': 'Projet MCP approuvé · serveur dédié',
    'achieve.expo': 'Autism Expo',
    'achieve.expo.p': 'Pilote Sky sur site · TRL 6',
    'achieve.hub': 'Campus numérique IA',
    'achieve.hub.p': 'Test de terrain du programme éducatif MSIT',
    'achieve.gap': 'Gap year jeunesse Gyeonggi',
    'achieve.gap.p': 'Mentor vidéo IA · 6 équipes',
    'achieve.social': 'Appui démarrage entreprise sociale',
    'achieve.social.p': 'Parcours early-startup · statut préparatoire en cours',
    ...
    'footer.corp': 'AI41 · AI FOR ONE · Songpa, Séoul · Créée le 2025.08.25',
    ...
    'route.quote': 'Je lance le programme de devis !',
    'route.maps': 'Je cherche sur la carte !',
    'route.aboutAi41': 'Voici AI41 !',
    'route.aboutSky': 'Voici Sky !',
    'route.search': 'J’ouvre la recherche !',
    'route.house': 'J’ouvre la carte logement !',
    'route.utils': 'J’ouvre les calculateurs !',
    'weather.fail': 'Impossible de récupérer la météo.',
    'maps.fail': 'Lieu introuvable.',
    'utils.title': 'Outils',
    'utils.sub': 'Surface, prêt, J-jour, change, air, minuteur. Les chiffres viennent du programme.',
    'utils.fxFail': 'Impossible de récupérer le taux.',
    'utils.airFail': 'Impossible de récupérer la qualité de l’air.',
    'search.title': 'Recherche',
    'search.sub': 'Ouvre Google ou Naver dans un nouvel onglet.',
    'search.query': 'Que chercher',
    'search.placeholder': 'ex. neurodiversité',
    'search.google': 'Google',
    'search.naver': 'Naver',
    'search.needQuery': 'Écrivez ce qu’il faut chercher. Ex. : « cherche sur Google ».',
    'sky.apiKey': 'Clé API',
    'fab.home': 'Accueil',
    'fab.aboutAi41': 'À propos d’AI41',
    'fab.aboutSky': 'À propos de Sky',
    'fab.search': 'Recherche',
    'fab.tarot': 'Tarot',
