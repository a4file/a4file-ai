...
const I18N_STRINGS = {
  ko: {
    ...
    'partners.h2': '연대 허브',
    'blog.h2': 'AI41 소식',
    'blog.sub': '썸네일과 제목으로 살펴보고, 카드를 누르면 본문을 읽어요.',
    'blog.empty': '아직 게시된 글이 없어요.',
    'blog.reader': '소식',
    'blog.openFail': '글을 불러오지 못했어요.',
    'blog.prev': '이전 소식',
    'blog.next': '다음 소식',
    'contact.h2': '함께할까요?',
    ...
    'route.weather': '날씨를 살펴볼게!',
    'route.maps': '지도를 찾아볼게!',
    'weather.fail': '날씨를 불러오지 못했어요.',
    'maps.fail': '장소를 찾지 못했어요.',
    'sky.apiKey': 'API 키',
    'fab.home': '홈으로',
  ...
  en: {
    ...
    'blog.h2': 'AI41 Stories',
    'blog.sub': 'Browse thumbnails and titles — tap a card to read.',
    'blog.empty': 'No published posts yet.',
    'blog.reader': 'Stories',
    'blog.openFail': 'Could not load that post.',
    'blog.prev': 'Previous',
    'blog.next': 'Next',
    ...
    'route.weather': 'Checking the weather!',
    'route.maps': 'Looking that place up!',
    'weather.fail': 'Could not fetch the weather.',
    'maps.fail': 'Could not find that place.',
    'sky.apiKey': 'API key',
    'fab.home': 'Home',
  ...
  ja: {
    ...
    'partners.h2': '連帯ハブ',
    'blog.h2': 'AI41ニュース',
    'blog.sub': 'サムネイルとタイトルで見て、カードを押すと本文を読めます。',
    'blog.empty': 'まだ公開された記事がありません。',
    'blog.reader': 'ニュース',
    'blog.openFail': '記事を読み込めませんでした。',
    'blog.prev': '前へ',
    'blog.next': '次へ',
    ...
    'route.weather': '天気を調べるね！',
    'route.maps': '地図を探すね！',
    'weather.fail': '天気を取得できませんでした。',
    'maps.fail': '場所が見つかりませんでした。',
    'sky.apiKey': 'APIキー',
    'fab.home': 'ホームへ',
  ...
  zh: {
    ...
    'partners.h2': '连带枢纽',
    'blog.h2': 'AI41 动态',
    'blog.sub': '浏览缩略图与标题，点卡片阅读正文。',
    'blog.empty': '暂无已发布文章。',
    'blog.reader': '动态',
    'blog.openFail': '无法加载文章。',
    'blog.prev': '上一页',
    'blog.next': '下一页',
    'contact.h2': '一起合作吗？',
  ...
  fr: {
    ...
    'blog.h2': 'Actus AI41',
    'blog.sub': 'Vignettes et titres — touchez une carte pour lire.',
    'blog.empty': 'Aucun article publié pour le moment.',
    'blog.reader': 'Actus',
    'blog.openFail': 'Impossible de charger l’article.',
    'blog.prev': 'Précédent',
    'blog.next': 'Suivant',
    ...
    'route.weather': 'Je regarde la météo !',
    'route.maps': 'Je cherche sur la carte !',
    'weather.fail': 'Impossible de récupérer la météo.',
    'maps.fail': 'Lieu introuvable.',
    'sky.apiKey': 'Clé API',
    'fab.home': 'Accueil',
